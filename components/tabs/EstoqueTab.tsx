    ...
    <>
      <tr style={{ opacity: product.ativo ? 1 : 0.5 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginTop: 3 }}>
                {product.sku
                  ? <span style={{ background: "rgba(52,131,250,.12)", color: "#3483FA", padding: "1px 7px", borderRadius: 6, fontWeight: 700, fontSize: ".7rem" }}>SKU {product.sku}</span>
                ...
                {anuncios.map(({ mlb, item }) => (
                  <span key={mlb} style={{ fontSize: ".7rem", background: "var(--surface2)", border: "1px solid var(--border)", padding: "1px 6px", borderRadius: 5, color: "var(--muted)" }}>
                    ...
                    {item && item.hasPromo && <span style={{ marginLeft: 4, fontSize: ".62rem", color: "#FF9F1C", fontWeight: 700 }}>promo</span>}
                    {item && <span style={{ marginLeft: 4, color: ehFullLogistic(item.logistic) ? "#3483FA" : "var(--muted)" }}>{ehFullLogistic(item.logistic) ? "Full" : "próprio"}</span>}
                  </span>
                ))}
              </div>
            </div>
        ...
        <td data-label="Full (ML)" style={{ textAlign: "right", fontWeight: 700, whiteSpace: "nowrap", color: !ehFull ? "var(--muted)" : fullBaixo ? "var(--red)" : "var(--green)" }}>
          {ehFull ? `${full} un` : "—"}
          {fullBaixo && casa > 0 && <span title="Envie de casa pro Full" style={{ display: "block", fontSize: ".62rem", color: "#FF9F1C" }}>reabastecer</span>}
        ...
        <td data-label="Preço venda" style={{ textAlign: "right", color: precoMax > 0 ? "var(--green)" : "var(--muted)", fontWeight: 600, whiteSpace: "nowrap" }}>
          ...
          {temPromo && <span style={{ display: "block", fontSize: ".62rem", color: "#FF9F1C" }}>promoção</span>}
        </td>
...
function MovimentoModal({ product, tipo, estoqueML, onClose, onSaved }: { product: Product; tipo: MovimentoTipo; estoqueML: EstoqueML; onClose: () => void; onSaved: () => void }) {
  ...
  return (
    <Modal open onClose={onClose}>
      ...
      {isSaldo && (
        <div style={{ margin: "4px 0 12px", padding: "8px 12px", borderRadius: 8, background: "rgba(52,131,250,.08)", border: "1px solid rgba(52,131,250,.2)", fontSize: ".78rem", color: "var(--muted)" }}>
          {full > 0
      ...
      {tipo === "saida_full" && (
        <div style={{ margin: "4px 0 12px", padding: "8px 12px", borderRadius: 8, background: "rgba(255,159,28,.08)", border: "1px solid rgba(255,159,28,.25)", fontSize: ".78rem", color: "var(--muted)" }}>
                ...
                return (
                  <tr key={p.id}>
                    <td style={{ textAlign: "left", fontWeight: 600 }}>
                      {p.name || "Sem nome"}
                      {mlbsDe(p).length === 0 ? (
                        <span style={{ display: "block", fontSize: ".66rem", fontWeight: 400, color: "#FF9F1C" }}>
    ...
    <Modal open onClose={onClose}>
      ...
      {carregando ? (
        ...
        <div style={{
          ...
          background: "rgba(240,68,82,.12)", border: "1px solid rgba(240,68,82,.4)",
          fontFamily: "ui-monospace, monospace", fontSize: ".72rem", whiteSpace: "pre-wrap",
        }}>{erro}</div>
      ) : concluido ? (
        <div style={{
          margin: "12px 0", padding: "12px 14px", borderRadius: 8,
          background: "rgba(32,199,119,.1)", border: "1px solid rgba(32,199,119,.4)",
          ...
          {resumo && (
            <div style={{
              ...
              {resumo.aproximados > 0 && (
                <span style={{ background: "rgba(255,159,28,.12)", border: "1px solid rgba(255,159,28,.4)", borderRadius: 6, padding: "4px 9px", color: "#FF9F1C" }}>
                  ...
                  {item.novos.map((n) => {
                    ...
                    return (
                      <label key={n.mlb} style={{
                        ...
                        background: on ? "rgba(32,199,119,.08)" : "var(--surface2)",
                        border: `1px solid ${on ? "rgba(32,199,119,.35)" : "var(--border)"}`,
                      }}>
                        <input
                        ...
                        <span style={{ minWidth: 0 }}>
                          ...
                          {!n.exato && (
                            <span style={{ marginLeft: 6, fontSize: ".64rem", fontWeight: 700, color: "#FF9F1C", background: "rgba(255,159,28,.12)", padding: "1px 5px", borderRadius: 4 }}>
                              APROXIMADO
                            </span>
                          )}
                          {n.titulo && (
  ...
  return (
    <Modal open onClose={onClose}>
          ...
          {produtos.map((p) => {
            ...
            return (
              <label key={p.id} style={{
                ...
                borderRadius: 6, cursor: "pointer", background: on ? "rgba(52,131,250,.1)" : undefined,
              }}>
                ...
                <span style={{ fontSize: ".74rem", color: atual > 0 ? "#FF9F1C" : "var(--muted)", whiteSpace: "nowrap" }}>
      ...
      <div style={{
        ...
        {jaTem.length > 0 && (
          <div style={{ marginTop: 6, color: "#FF9F1C" }}>
            {jaTem.length === 1
          ...
          {pendentes.map((r) => {
            ...
            return (
              <div key={r.remessa} style={{
                ...
                <div style={{
                  ...
                  {feita ? (
                    <span style={{
                      ...
                      background: "rgba(32,199,119,.12)", border: "1px solid rgba(32,199,119,.35)",
                    ...
                    <div key={p.inventory} style={{
                      ...
                      <input
                        ...
                        style={{
                          ...
                          border: `1px solid ${dif !== 0 && !movExistente && p.productId ? "rgba(255,159,28,.5)" : "var(--border)"}`,
                ...
                {!!semCadastro.length && (
                  <div style={{
                    fontSize: ".75rem", color: "#FF9F1C", marginTop: 10, padding: "7px 10px",
                    background: "rgba(255,159,28,.1)", borderRadius: 8, lineHeight: 1.5,
                  }}>
